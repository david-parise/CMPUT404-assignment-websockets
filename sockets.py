...
def subscribe_socket(ws):
    ...
    try:
        ...
        print(f"WS error in subscribe socket: {e}")
    finally:
...
def update(entity):
    ...
    json_string = json.dumps(myWorld.get(entity))
    return Response(json_string, content_type='application/json', status=200)
